...
let
  ...
  gtkcss = ''
    ...
    @define-color view_bg_color ${colors.bg-opacity};
    ...
    @define-color headerbar_border_color ${colors.border-opacity};
    @define-color headerbar_backdrop_color @window_bg_color;
    @define-color headerbar_shade_color rgba(0, 0, 0, 0.07);
    @define-color headerbar_darker_shade_color rgba(0, 0, 0, 0.07);
    @define-color sidebar_bg_color ${colors.bg-secondary-opacity};
    @define-color sidebar_fg_color ${colors.fg};
    @define-color sidebar_backdrop_color @window_bg_color;
    @define-color sidebar_shade_color rgba(0, 0, 0, 0.07);
    @define-color secondary_sidebar_bg_color ${colors.bg-tertiary-opacity};
    @define-color secondary_sidebar_fg_color @sidebar_fg_color;
    @define-color secondary_sidebar_backdrop_color @sidebar_backdrop_color;
    @define-color secondary_sidebar_shade_color @sidebar_shade_color;
    @define-color card_bg_color ${colors.bg-secondary-opacity};
    @define-color card_fg_color ${colors.fg};
    @define-color card_shade_color rgba(0, 0, 0, 0.07);
    @define-color dialog_bg_color ${colors.bg-secondary-opacity};
    @define-color dialog_fg_color ${colors.fg};
    @define-color popover_bg_color ${colors.bg-secondary-opacity};
    @define-color popover_fg_color ${colors.fg};
    @define-color popover_shade_color rgba(0, 0, 0, 0.07);
    @define-color shade_color rgba(0, 0, 0, 0.07);
    @define-color scrollbar_outline_color ${colors.bg-tertiary-opacity};
